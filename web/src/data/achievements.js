...
export const ACHIEVEMENTS = [
  ...
  },
  {
    id: 'quality_farmer',
    name: 'Quality Farmer',
    desc: 'Harvest 5 high-quality crops',
    reward: 45,
    icon: '⭐',
    category: 'farming',
  },
  ...
  },
  {
    id: 'season_expert',
    name: 'Season Expert',
    desc: 'Plant 5 crops in their optimal season',
    reward: 35,
    icon: '🍂',
    category: 'environment',
  },
  ...
  },
  {
    id: 'bee_friend',
    name: 'Bee Friend',
    desc: 'Maintain max bee happiness for 5 minutes',
    reward: 50,
    icon: '🐝',
    category: 'environment',
  },
  ...
  },
  {
    ...
    desc: 'Eliminate 10 pest infestations',
    reward: 30,
    icon: '🧽',
    category: 'challenge',
  },
  ...
  },
  {
    id: 'no_wilt',
    name: 'Perfect Care',
    desc: 'Go 10 minutes without any crop wilting',
    reward: 90,
    icon: '💚',
    category: 'challenge',
  },
  ...
  // BREEDING & DISCOVERY
  {
    id: 'first_hybrid',
    name: 'Hybrid Pioneer',
    desc: 'Breed your first hybrid crop',
    reward: 75,
    icon: '🧬',
    category: 'breeding',
  },
  {
    ...
    desc: 'Discover 3 crop mutations',
    reward: 100,
    icon: '✨',
    category: 'breeding',
  },
  {
    ...
    desc: 'Create a legendary hybrid',
    reward: 200,
    icon: '🔥',
    category: 'breeding',
  },
  {
    ...
    name: 'Seed Collector',
    desc: 'Unlock all crop varieties',
    reward: 300,
    icon: '📖',
    category: 'breeding',
  },
  ...
  },
  {
    id: 'farm_empire',
    name: 'Farm Empire',
    desc: 'Own 5 different buildings',
    reward: 150,
    icon: '🏰',
    category: 'building',
  },
  ...
  },
  {
    id: 'pet_master',
    name: 'Pet Master',
    desc: "Max out a pet's happiness",
    reward: 60,
    icon: '❤️',
    category: 'building',
  },
...
export const ACHIEVEMENT_CATEGORIES = {
  ...
  milestone: {
    name: 'Milestone',
    emoji: '🏆',
    color: 'bg-gradient-to-r from-yellow-100 to-amber-100 text-amber-800',
  },
};
