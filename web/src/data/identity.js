...
export const MEMORIES = [
  ...
  },
  {
    id: 'turnip_treat',
    title: 'Turnip Treat',
    description: 'Harvested your first turnip.',
    hint: 'Harvest turnips in spring.',
    chapterId: 'spring_beginnings',
    icon: '🌱',
    order: 3.5,
    isMicro: true,
  ...
  {
    id: 'snowdrop_harvest',
    title: 'Snowdrop Bloom',
    description: 'Harvested your first snowdrop.',
    hint: 'Harvest snowdrops in winter.',
    chapterId: 'winter_quiet',
    icon: '❄️',
    order: 10.5,
    isMicro: true,
  },
  {
    id: 'ginger_harvest',
    title: 'Ginger Warmth',
    description: 'Harvested your first ginger root.',
    hint: 'Harvest ginger root in winter.',
    chapterId: 'winter_quiet',
    icon: '🫚',
    order: 11,
    isMicro: true,
  ...
  },
  {
    ...
    description: 'Placed a cozy decor piece from the season pack.',
    hint: 'Place a Season Pack v1 decoration.',
    chapterId: 'cozy_corners',
    icon: '🧺',
    order: 15,
    isMicro: true,
  ...
  {
    id: 'cozy_goal_complete',
    title: 'Cozy Goal Complete',
    description: 'Completed a Cozy Goal from the Town Board.',
    hint: 'Complete any Cozy Goal.',
    chapterId: 'cozy_corners',
    icon: '🧺',
    order: 16,
    isMicro: true,
  ...
  },
  {
    id: 'winter_market',
    title: 'Hearth Market',
    description: 'Shared warmth at the Winter Hearth Market.',
    hint: 'Complete the Winter Hearth Market event.',
    chapterId: 'festival_glow',
    icon: '🔥',
    order: 17.5,
    isMicro: true,
  ...
  },
  {
    id: 'golden_crop',
    title: 'Golden Crop',
    description: 'Harvested a once-in-a-while golden crop.',
    hint: 'A very rare harvest can sparkle gold.',
    chapterId: 'festival_glow',
    icon: '🌟',
    order: 210,
  },
  {
    ...
    description: 'Saw a meteor streak above your fields.',
    hint: 'Sometimes the night sky has a surprise.',
    chapterId: 'lantern_nights',
    icon: '🌠',
    order: 211,
  },
  {
    ...
    title: 'Perfect Harvest Morning',
    description: 'Welcomed a morning where everything felt in sync.',
    hint: 'A rare morning mood can greet a new day.',
    chapterId: 'spring_beginnings',
    icon: '🌅',
    order: 212,
  },
  {
    id: 'lantern_walk_complete',
    title: 'Lantern Walk Complete',
    description: 'Completed the Lantern Walk decor set.',
    hint: 'Place matching decor pieces to finish a set.',
    chapterId: 'cozy_corners',
    icon: '🏮',
    order: 213,
  },
  {
    id: 'hearth_garden_complete',
    title: 'Hearth Garden Complete',
    description: 'Completed the Hearth Garden decor set.',
    hint: 'Decor sets reward cozy curation.',
    chapterId: 'cozy_corners',
    icon: '🧺',
    order: 214,
  },
  {
    id: 'harvest_border_complete',
    title: 'Harvest Border Complete',
    description: 'Completed the Harvest Border decor set.',
    hint: 'Seasonal touches can complete a set.',
    chapterId: 'cozy_corners',
    icon: '🎃',
    order: 215,
  },
