...
describe('FarmingSystem', () => {
  ...
  it('should auto-harvest up to two ready plots when drone harvester is owned', () => {
    ...
    mockGameState.plots[0] = {
      state: 'ready',
      crop: { id: 'carrot', baseValue: 20, name: 'Carrot', emoji: '🥕' },
      soilFertility: 1.0,
    };
    mockGameState.plots[1] = {
      state: 'ready',
      crop: { id: 'potato', baseValue: 18, name: 'Potato', emoji: '🥔' },
      soilFertility: 1.0,
    };
    mockGameState.plots[2] = {
      state: 'ready',
      crop: { id: 'corn', baseValue: 16, name: 'Corn', emoji: '🌽' },
      soilFertility: 1.0,
    };
    farmingSystem = new FarmingSystem(mockGameState, mockActions);
