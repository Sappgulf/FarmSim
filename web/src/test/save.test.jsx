...
import { GameProvider, useGame } from '../components/farm-sim/context/GameContext'; // check export later
...
describe('Save System Stability', () => {
  ...
  it('auto-save persists farmName changes even when tracked economy fields do not change', () => {
    ...
    const rafMock = vi
      ...
      .mockImplementation((callback) => setTimeout(() => callback(Date.now()), 1000));
