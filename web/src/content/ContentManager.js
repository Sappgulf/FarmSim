...
const PACK_META_MODULES = import.meta.glob('../../../shared/content/packs/**/pack.json', { eager: true });
const PACK_CROP_MODULES = import.meta.glob('../../../shared/content/packs/**/crops.json', { eager: true });
const PACK_DECOR_MODULES = import.meta.glob('../../../shared/content/packs/**/decor.json', { eager: true });
const PACK_FESTIVAL_MODULES = import.meta.glob('../../../shared/content/packs/**/festivals.json', { eager: true });
const PACK_ALMANAC_MODULES = import.meta.glob('../../../shared/content/packs/**/almanac.json', { eager: true });
const PACK_MINIGAME_MODULES = import.meta.glob('../../../shared/content/packs/**/minigames.json', { eager: true });
const PACK_STRING_MODULES = import.meta.glob('../../../shared/content/packs/**/strings.json', { eager: true });
const PACK_BUILDING_MODULES = import.meta.glob('../../../shared/content/packs/**/buildings.json', { eager: true });
const PACK_RESEARCH_MODULES = import.meta.glob('../../../shared/content/packs/**/research.json', { eager: true });
const PACK_GENETICS_MODULES = import.meta.glob('../../../shared/content/packs/**/genetics.json', { eager: true });
const PACK_LIVESTOCK_MODULES = import.meta.glob('../../../shared/content/packs/**/livestock.json', { eager: true });
const PACK_PETS_MODULES = import.meta.glob('../../../shared/content/packs/**/pets.json', { eager: true });
const PACK_FISHING_MODULES = import.meta.glob('../../../shared/content/packs/**/fishing.json', { eager: true });
const PACK_CHALLENGE_MODULES = import.meta.glob('../../../shared/content/packs/**/challenges.json', { eager: true });
