...
export const ACHIEVEMENTS = [
  ...
  // === COZY IDENTITY v1 - COLLECTION MILESTONES ===
  {
    id: 'first_discovery',
    name: 'First Discovery',
    description: 'Add your first crop to the collection',
    emoji: '📖',
    category: 'cozy',
    requirement: { type: 'collection_discovered', count: 1 },
    reward: { coins: 25, xp: 15 },
    rarity: 'common',
  },
  {
    ...
    description: 'Discover 5 different crops for your collection',
    emoji: '🌻',
    category: 'cozy',
    requirement: { type: 'collection_discovered', count: 5 },
    reward: { coins: 75, xp: 40 },
    rarity: 'common',
  },
  {
    id: 'steadfast_collector',
    name: 'Steadfast Collector',
    description: 'Earn a Steadfast milestone on any crop',
    emoji: '🎖️',
    category: 'cozy',
    requirement: { type: 'collection_steadfast', count: 1 },
    reward: { coins: 150, xp: 75 },
    rarity: 'uncommon',
  },
  {
    ...
    description: 'Earn a Legendary milestone on any crop',
    emoji: '🏆',
    category: 'cozy',
    requirement: { type: 'collection_legend', count: 1 },
    reward: { coins: 500, xp: 250 },
    rarity: 'rare',
  },
  {
    id: 'encyclopedia_scholar',
    name: 'Encyclopedia Scholar',
    description: 'Discover 15 crops for your collection',
    emoji: '📚',
    category: 'cozy',
    requirement: { type: 'collection_discovered', count: 15 },
    reward: { coins: 750, xp: 350 },
    rarity: 'epic',
  },

  // === COZY IDENTITY v1 - TOWN REPUTATION ===
  {
    id: 'town_newcomer',
    name: 'Town Newcomer',
    description: 'Earn your first 10 reputation points',
    emoji: '👋',
    category: 'cozy',
    requirement: { type: 'reputation', count: 10 },
    reward: { coins: 50, xp: 25 },
    rarity: 'common',
  },
  {
    ...
    description: 'Reach 100 town reputation',
    emoji: '🤝',
    category: 'cozy',
  ...
  },
  {
    id: 'town_favorite',
    name: 'Town Favorite',
    description: 'Reach 500 town reputation',
    emoji: '🌟',
    category: 'cozy',
  ...
  },
  {
    id: 'beloved_farmer',
    name: 'Beloved Farmer',
    description: 'Reach 1000 town reputation',
    emoji: '💕',
    category: 'cozy',
  ...
  // === COZY IDENTITY v1 - SEASONAL ACHIEVEMENTS ===
  {
    id: 'spring_spirit',
    name: 'Spring Spirit',
    description: 'Harvest 10 crops during Spring',
    emoji: '🌸',
    category: 'cozy',
    requirement: { type: 'seasonal_harvest', season: 'spring', count: 10 },
    reward: { coins: 100, xp: 50 },
    rarity: 'common',
  },
  {
    ...
    description: 'Harvest 10 crops during Summer',
    emoji: '☀️',
    category: 'cozy',
    requirement: { type: 'seasonal_harvest', season: 'summer', count: 10 },
    reward: { coins: 100, xp: 50 },
    rarity: 'common',
  },
  {
    id: 'fall_bounty',
    name: 'Fall Bounty',
    description: 'Harvest 10 crops during Fall',
    emoji: '🍂',
    category: 'cozy',
    requirement: { type: 'seasonal_harvest', season: 'fall', count: 10 },
    reward: { coins: 100, xp: 50 },
    rarity: 'common',
  },
  {
    id: 'winter_warmth',
    name: 'Winter Warmth',
    description: 'Harvest 10 crops during Winter',
    emoji: '❄️',
    category: 'cozy',
    requirement: { type: 'seasonal_harvest', season: 'winter', count: 10 },
    reward: { coins: 150, xp: 75 },
    rarity: 'uncommon',
  },
  {
    id: 'all_seasons_farmer',
    name: 'All-Seasons Farmer',
    description: 'Harvest crops in all four seasons',
    emoji: '🌈',
    category: 'cozy',
    requirement: { type: 'seasonal_completion', count: 4 },
    reward: { coins: 400, xp: 200 },
    rarity: 'rare',
  },
  {
    ...
    description: 'Use Photo Mode for the first time',
    emoji: '📷',
    category: 'cozy',
    requirement: { type: 'photo_mode', count: 1 },
    reward: { coins: 50, xp: 25 },
    rarity: 'common',
  },
  {
    id: 'farm_decorator',
    name: 'Farm Decorator',
    description: 'Place 10 decorations on your farm',
    emoji: '🎪',
    category: 'cozy',
    requirement: { type: 'decorations_placed', count: 10 },
    reward: { coins: 150, xp: 75 },
    rarity: 'uncommon',
  },
  {
    id: 'cozy_homesteader',
    name: 'Cozy Homesteader',
    description: 'Name your farm and choose a theme',
    emoji: '🏡',
    category: 'cozy',
    requirement: { type: 'identity_complete', count: 1 },
    reward: { coins: 100, xp: 50 },
    rarity: 'common',
  },
];
...
export const ACHIEVEMENT_CATEGORIES = {
  ...
  cozy: { name: 'Cozy', emoji: '🏡', color: 'amber' },
};
