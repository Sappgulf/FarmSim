...
export const CROP_DATA = {
  ...
  parsnip: {
    ...
    cost: 14,
    baseValue: 30,
    growthTime: 68, // Mildly longer than carrot
    stages: 3,
    description: 'Sweet, earthy root with cozy value.',
    category: 'vegetable',
    season: 'spring',
    level: 1,
  },
  ...
  okra: {
    ...
    growthTime: 96,
    stages: 4,
    description: 'Tender summer pods with steady returns.',
    category: 'vegetable',
    season: 'summer',
    level: 2,
  },
  ...
  cranberry: {
    ...
    growthTime: 132,
    stages: 4,
    description: 'Bright tart berries for autumn cheer.',
    category: 'fruit',
    season: 'fall',
    level: 3,
  },
